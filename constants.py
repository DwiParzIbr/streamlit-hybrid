...
METHOD_DCT_EMD = "Hybrid - DCT + EMD"
METHOD_DWT_LSB = "Hybrid - DWT + LSB"
METHOD_DWT_PVD = "Hybrid - DWT + PVD"
METHOD_DWT_EMD = "Hybrid - DWT + EMD"
METHOD_FFT_LSB = "Hybrid - FFT + LSB"
METHOD_FFT_PVD = "Hybrid - FFT + PVD"
METHOD_FFT_EMD = "Hybrid - FFT + EMD" # <--- DITAMBAHKAN
